...
function InfoBadgeComponent() {
    return (
        <div style={{ width: "100vw", height: "80px", marginTop: "2%" }}>
            <div style={{ width: "25%", height: "100%", marginLeft: "17.5vw", borderRadius: "5px", padding: "5px" }} className="border border-2 d-flex flex-col">
                <div className="d-flex flex-row">
                    <div>badges</div>
                </div>
                <div className="d-flex flex-row overflow-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" style={{ height: "20px", width: "10px", }}>
