                    ...
                    <ul className="navbar-nav ms-auto">
                        ...
                        <li className="nav-item"><a className="nav-link" href="https://discord.com/oauth2/authorize?client_id=976141006389014588&scope=bot&permissions=3201">Invite Bot</a></li>
                        {
                            isLoggined ? (
                                ...
                                (
                                    <li className="nav-item"><a className="nav-link" href="https://discord.com/oauth2/authorize?client_id=976141006389014588&redirect_uri=https%3A%2F%2Frain.blue&response_type=code&scope=identify" target="_self">Login</a></li>
                                )
                        }
